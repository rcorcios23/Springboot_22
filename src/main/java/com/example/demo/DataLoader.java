...
import org.springframework.security.crypto.password.PasswordEncoder;/* new after adding @Autowired private password*/
...
public class DataLoader implements CommandLineRunner{
    ...
    public void run(String... strings) throws Exception {
        ...
        user = new User("sam@very.com", "password", "Sam", "Everyman", true, "everyman");
        user.setRoles(Arrays.asList(userRole, adminRole));
        userRepository.save(user);
    }
}
